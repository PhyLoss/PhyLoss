...
'''
File containing clusters, file format:

(1)	pgi|0000000003765329809|ti|37653|pi|0|	37653	14	16	3 //cluster id line contains:, cluster num, cluster id,
                                                            //spec id, ps gain, ps loss, cluster member count 
pgi|0000000003765329809|ti|37653|pi|0| //member (only id)
pgi|0000000000720369062|ti|72036|pi|0| //member (only id)
pgi|0000000001022810253|ti|10228|pi|0| //member (only id)
'''

'''
Path to results file, file format:
pgi|0000000003765330193|ti|37653|pi|0|          //cluster id
GO:0008092	2	20	50446	23186638	0.0008761817681909975	0.004233352765518997	5.67 // function id, quant, sample, hit, total, p-value (hypergeom test), p-adjusted, real log odds
GO:0050877	2	20	147561	23186638	0.007130716236820739	0.027405995350316854	4.12
GO:0005856	2	20	175380	23186638	0.009929598666530285	0.03643075920796019	3.87
