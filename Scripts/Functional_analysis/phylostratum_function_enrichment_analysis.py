...
"""
# Usage: python3 phylostratum_function_enrichment_analysis.py -i INPUT_FOLDER -s H -C -c 0.8 -p -o OUTPUT_FOLDER \
...
def parseArgv(argv):
	...
	try:
		...
		print("Error. Usage: phylostratum_function_enrichment_analysis.py -i <input_directory> -s <species> -G[|-C]" + \
	...
	for opt, arg in opts:
		print(opt + "\t" + arg)
		if opt in ("-h", "--help"):
			print("Usage: phylostratum_function_enrichment_analysis.py -i <input_directory> -s <species> -G[|-C] -c <c_value> [-p]" + \
