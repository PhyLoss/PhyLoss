...
# Example: time awk -v t=9606 -v P=39 -f getGL_HS.awk PATH_TO_ANALYSIS_FOLDER/results_0_8/dbAllPlus_clu_0_8_HS_out_EXT.txt > PATH_TO_ANALYSIS_FOLDER/results_0_8/res_dbAllPlus_clu_0_8_HS_out_EXT.txt
#

# fill a 
function get_a(a ) {
	# all H. sap.'s parents up to the root were precomputed using treeTaxId.awk
	a[1 ] = 9606	# Homo_sapiens
	a[2 ] = 5000016	# Hominini
	a[3 ] = 207598	# Homininae
	a[4 ] = 9604	# Hominidae
	a[5 ] = 314295	# Hominoidea
	a[6 ] = 9526	# Catarrhini
	a[7 ] = 314293	# Simiiformes
	a[8 ] = 376913	# Haplorrhini
	a[9 ] = 9443	# Primates
	a[10] = 5000015	# Euarchonta
	a[11] = 314146	# Euarchontoglires
	a[12] = 1437010	# Boreoeutheria
	a[13] = 9347	# Placentalia
	a[14] = 722675	# Theria
	a[15] = 40674	# Mammalia
	a[16] = 32524	# Amniota
	a[17] = 32523	# Tetrapoda
	a[18] = 8287	# Sarcopterygii
	a[19] = 117571	# Euteleostomi
	a[20] = 35060	# Gnathostomata
	a[21] = 1261581	# Vertebrata
	a[22] = 5000011	# Olfactores
	a[23] = 7711	# Chordata
	a[24] = 33511	# Deuterostomia
	a[25] = 33213	# Bilateria
	a[26] = 6072	# Eumetazoa
	a[27] = 33208	# Metazoa
	a[28] = 3000015	# Choanozoa
	a[29] = 3000013	# Filozoa
	a[30] = 3000012	# Holozoa
	a[31] = 33154	# Opisthokonta
	a[32] = 3000011	# Obazoa
	a[33] = 163718	# Amorpheae
	a[34] = 2759	# Eukaryota
	a[35] = 3000004	# Asgard_archaea/Eukaryota
	a[36] = 3000003	# TACK/Asgard_archaea/Eukaryota
	a[37] = 3000002	# Euryarchaeota/TACK/Asgard_archaea/Eukaryota
	a[38] = 3000001	# DPANN/Euryarchaeota/TACK/Asgard_archaea/Eukaryota
