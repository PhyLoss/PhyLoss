...
"""
Usage: python3 numClusters.py -i names.txt -j . -t PATH_TO_ANALYSIS_FOLDER/results_0_8/db_clu_all.tsv -o PATH_TO_ANALYSIS_FOLDER/results_0_8/
--> -i option: input file with all species' taxId-s + names
--> -j option: input directory where ps files for each focal species are stored (e.g. ps files: taxId_ps_Hsap.txt ...)
