...
# Example: time awk -v t=7227 -v P=31 -f getGL_Dmel.awk PATH_TO_ANALYSIS_FOLDER/results_0_8/dbAllPlus_clu_0_8_Dmel_out_EXT.txt > PATH_TO_ANALYSIS_FOLDER/results_0_8/res_dbAllPlus_clu_0_8_Dmel_out_EXT.txt
#

# fill a 
function get_a(a ) {
	# all D. mel.'s parents up to the root were precomputed using treeTaxId.awk
	a[1 ] = 7227	# Drosophila_melanogaster
	a[2 ] = 6000011	# Drosophila_similans/sechellia/melanogaster_group
	a[3 ] = 6000009	# Drosophila_melanogaster_subgroup
	a[4 ] = 6000007	# Drosophila_melanogaster_group
	a[5 ] = 32341	# Sophophora
	a[6 ] = 2081351	# Drosophila
	a[7 ] = 480117	# Cyclorrhapha
	a[8 ] = 5000009	# Diptera
	a[9 ] = 6000001	# Mecopterida
	a[10] = 6000000	# Aparaglossata
	a[11] = 33392	# Holometabola
	a[12] = 50557	# Insecta
	a[13] = 197562	# Pancrustacea
	a[14] = 6656	# Arthropoda
	a[15] = 1206794	# Ecdysozoa
	a[16] = 33317	# Protostomia
	a[17] = 33213	# Bilateria
	a[18] = 6072	# Eumetazoa
	a[19] = 33208	# Metazoa
	a[20] = 3000015	# Choanozoa
	a[21] = 3000013	# Filozoa
	a[22] = 3000012	# Holozoa
	a[23] = 33154	# Opisthokonta
	a[24] = 3000011	# Obazoa
	a[25] = 163718	# Amorpheae
	a[26] = 2759	# Eukaryota
	a[27] = 3000004	# Asgard_archaea/Eukaryota
	a[28] = 3000003	# TACK/Asgard_archaea/Eukaryota
	a[29] = 3000002	# Euryarchaeota/TACK/Asgard_archaea/Eukaryota
	a[30] = 3000001	# DPANN/Euryarchaeota/TACK/Asgard_archaea/Eukaryota
	a[31] = 131567	# Cellular_organisms
}
